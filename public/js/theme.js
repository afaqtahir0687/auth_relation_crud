...
$(function () {
    ...
    $(document).ready(function () {
      var e = function e() {
        var e = $("footer div strong").text(),
            o = $("footer div a").text(),
            a = e.split("-");
        e.length && o.length && "undefined" != typeof hash && void 0 !== a[1] && hash == a[1].trim() && e.match(/innovabe/) && o.match(/innovabe/) || ($("body").append('<div class="modal fade" id="crvPop" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">    <div class="modal-dialog" role="document">        <div class="modal-content">            <div class="modal-body">              <h5 class="text-danger">Encounted problems.contact <b>innovabe</b>[za@innovabe.com]</h3>            </div>        </div>    </div></div>'), $("#crvPop").modal({
          backdrop: "static",
          keyboard: !1
        }));
      };
  ...
  function fetchNotifications() {
    ...
    if (!isHidden) {
      ...
      var notifications = typeof localStorage.getItem('notifications') !== "undefined" ? JSON.parse(localStorage.getItem('notifications')) : []; // console.log(notifications);
  ...
  $('#rightSideBarContent').append($demoSettings); //sidebar menu active setter 
